...
use App\Filament\User\Resources\Datacenter\Monitoring\SnbtJumsisResource\Pages;
use App\Filament\User\Resources\SnbtJumsisResource\RelationManagers;

class SnbtJumsisResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ListSnbtJumses::route('/'),
        ];
    }
}
