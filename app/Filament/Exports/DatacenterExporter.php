...
class DatacenterExporter extends Exporter
{
    ...
    {
        $body = 'Your datacenter export has completed and ' . number_format($export->successful_rows) . ' ' . str('row')->plural($export->successful_rows) . ' exported.';
